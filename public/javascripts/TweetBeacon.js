...
TweetBeacon = function(tweet) {
  ...
  this.color = 0xFFFFFF; // neutral

  if (tweet.sentiment.score < 0) {
    this.color = 0xFF0000; // negative red
  }
  else if (tweet.sentiment.score > 0) {
    this.color = 0x00FF00; // positive green
  }
...
TweetBeacon.prototype.show = function () {
  ...
  this.beamHeight = 100 + Math.abs(this.tweet.sentiment.score) * 100
